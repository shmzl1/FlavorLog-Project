...
from app.api.v1 import fridge_recipe_tasks
from app.api.v1 import food_records
from app.api.v1 import fridge_items
from app.api.v1 import food_records_compat
...
api_router.include_router(food_records_compat.router, prefix="/food-records", tags=["Food Records (兼容)"])
